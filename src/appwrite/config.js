...
export class Service {
  ...
  constructor() {
    ...
    this.databases = new Databases(this.client); // ISSE NEW DATABASE NAHI BAN RHA BAS HAMARE DATABSES WALE VARIABLE MAI FUNCTIONALITY DAAL RAHA HAI...ITS LIKE BODY HAI AUR USME JAAN DAAL RHA HAI AUR AB ISKA USE KARGEA.......DATABSE HAMNE APPWITE KI WEBSITE SI HI BNAYA THA TABHI USKI ID WAGERA LE KE AYE HAI AUR AB USI ID KO USE KRENGE JISSE JO NEW FUNCTIONALITIES AYI HAI IS LINE SE UNHE APNE PROJECT M USE KAR PAYE
